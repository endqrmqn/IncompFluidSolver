...
def interpolate_1d(w: xp.array, axis: int) -> xp.array: #type: ignore
    r"""
...
def evaluate_derivative(w: xp.array, d: float, order: int, axis: int): #type: ignore
    r"""
...
def evaluate_derivative_staggered(
    w: xp.array, d: float, axis: int #type: ignore
